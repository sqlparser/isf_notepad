...
static value_type _c_setvalue1st_impl(c_binary_function * thiz, value_type val1, value_type val2)
{
	 ((c_ppair)(val1))->second = ((c_ppair)(val2))->second;
	 return ((c_ppair)(val1))->second;
}

c_binary_function c_setvalue1st()
{
	c_binary_function bf;
	bf.O = _c_setvalue1st_impl;
	bf._l = NULL;
	return bf;    
}
